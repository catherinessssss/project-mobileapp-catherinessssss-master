...
//Rare exceptions to indicate a bug in the _project_mobileapp_catherinessssss code (Eg, function that a subclass should have implemented)
...
/**
 The base class for project_mobileapp_catherinessssss proxies.
 */
