...
//@interface project_mobileapp_catherinessssssObject : NSObject
//@end

@interface project_mobileapp_catherinessssssObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[project_mobileapp_catherinessssssObject class]])
		{
			for (NSString *key in [[(project_mobileapp_catherinessssssObject*)o modules] allKeys])
			{
