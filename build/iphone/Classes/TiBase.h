...
// in simulator we redefine to format for project_mobileapp_catherinessssss Developer console
...
{\
	NSString * exceptionName = [@"org.project_mobileapp_catherinessssss." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.project_mobileapp_catherinessssss";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIproject_mobileapp_catherinessssssNativeItemNone = -1, 
	UIproject_mobileapp_catherinessssssNativeItemSpinner = -2,
	UIproject_mobileapp_catherinessssssNativeItemProgressBar = -3,
	
	UIproject_mobileapp_catherinessssssNativeItemSlider = -4,
	UIproject_mobileapp_catherinessssssNativeItemSwitch = -5,
	UIproject_mobileapp_catherinessssssNativeItemMultiButton = -6,
	UIproject_mobileapp_catherinessssssNativeItemSegmented = -7,
	
	UIproject_mobileapp_catherinessssssNativeItemTextView = -8,
	UIproject_mobileapp_catherinessssssNativeItemTextField = -9,
	UIproject_mobileapp_catherinessssssNativeItemSearchBar = -10,
	
	UIproject_mobileapp_catherinessssssNativeItemPicker = -11,
	UIproject_mobileapp_catherinessssssNativeItemDatePicker = -12,
	
	UIproject_mobileapp_catherinessssssNativeItemInfoLight = -13,
	UIproject_mobileapp_catherinessssssNativeItemInfoDark = -14,
	
	UIproject_mobileapp_catherinessssssNativeItemDisclosure = -15,
	
	UIproject_mobileapp_catherinessssssNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all project_mobileapp_catherinessssss instances of
