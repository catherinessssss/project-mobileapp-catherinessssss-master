...
/**
 The base class for all project_mobileapp_catherinessssss modules
 */
...
/**
 project_mobileapp_catherinessssss Platform calls this method on startup.
 */
-(void)startup;

/**
 project_mobileapp_catherinessssss Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 project_mobileapp_catherinessssss Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 project_mobileapp_catherinessssss Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 project_mobileapp_catherinessssss Platform calls this method on resume.
 @param sender The sender of the event.
 */
