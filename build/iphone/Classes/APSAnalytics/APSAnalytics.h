 ...
 * to send analytic data that can be viewed on the project_mobileapp_catherinessssss Dashboard.
 *
 * For information on getting started with project_mobileapp_catherinessssss Platform Services,
