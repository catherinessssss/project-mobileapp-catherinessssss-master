...
/**
 Base class for all project_mobileapp_catherinessssss views.
 @see TiViewProxy
 */
#ifdef TI_USE_AUTOLAYOUT
...
/**
 Whether or not a view not normally picked up by the project_mobileapp_catherinessssss view hierarchy (such as wrapped iOS UIViews) was touched.
