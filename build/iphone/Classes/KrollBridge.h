...
@interface project_mobileapp_catherinessssssObject : KrollCoverageObject {
#else
@interface project_mobileapp_catherinessssssObject : KrollObject {
#endif
@private
...
extern NSString * project_mobileapp_catherinessssss$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	project_mobileapp_catherinessssssObject *_project_mobileapp_catherinessssss;
    KrollObject* console;
	BOOL shutdown;
